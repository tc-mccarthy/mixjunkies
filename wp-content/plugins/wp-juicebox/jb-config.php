...
<html xmlns="http://www.w3.org/1999/xhtml"<?php do_action('admin_xml_ns'); ?> <?php language_attributes('xhtml'); ?>>
	<head>
		...
		<link rel="stylesheet" href="<?php echo plugins_url('css/generate.css', __FILE__); ?>?ver=<?php echo $Juicebox->version ?>" type="text/css" charset="utf-8" />
		...
		<script type="text/javascript">
			...
			jQuery(document).ready(function() {
				try {
					...
					throw "JB is not defined. A Juicebox shortcode tag will not be inserted into the post.";
				}
			});
			// ]]>
		</script>
