...
class MPC_Widget extends WP_Widget {
	...
	function form($instance) {
		...
		<p><input class="checkbox" id="<?php echo $this->get_field_id('total'); ?>" name="<?php echo $this->get_field_name('total'); ?>" type="checkbox" <?php if ($total == 'on') { echo 'checked="checked"';}?>  />&nbsp;<label for="<?php echo $this->get_field_id('total'); ?>">Display total pages in (n) next to the category name.</label><br/>
		<input class="checkbox" id="<?php echo $this->get_field_id('expend'); ?>" name="<?php echo $this->get_field_name('expend'); ?>" type="checkbox" <?php if ($expend == 'on') { echo 'checked="checked"';}?>  />&nbsp;<label for="<?php echo $this->get_field_id('expend'); ?>">Collapse all categories.</label><br/>
		<input class="checkbox" id="<?php echo $this->get_field_id('desc'); ?>" name="<?php echo $this->get_field_name('desc'); ?>" type="checkbox" <?php if ($desc == 'on') { echo 'checked="checked"';}?>  />&nbsp;<label for="<?php echo $this->get_field_id('desc'); ?>">Display category description.</label></p>
		
		<p><strong>Select Categories:</strong></p><p>
		...
		foreach((array)$mpc_categories as $category) {
			...
			<input class="widefat" id="<?php echo $this->get_field_id('category_ids_' . $category->id); ?>" name="<?php echo $this->get_field_name('category_ids') . "[{$category->id}]"; ?>" type="checkbox"  <?php echo $checked ?>/>&nbsp;<label for="<?php echo $this->get_field_id('category_ids_' . $category->id); ?>"><?php echo $category->name ?></label><br/>
		...
		?>
		<input class="widefat" id="<?php echo $this->get_field_id('category_names'); ?>" name="<?php echo $this->get_field_name('category_names') . "[Uncategorized]"; ?>" type="checkbox"  <?php echo $checked ?>/>&nbsp;<label for="<?php echo $this->get_field_id('category_names'); ?>">Uncategorized</label>
