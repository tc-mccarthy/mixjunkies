		...
		<tr id="cat-<?php print $category->id?>" class="iedit <?php print $class ?>">
			...
			<td class="name column-name">
				...
				<span class="edit" id='<?php print $category->id?>'>
					...
					<span><a class="editinline" href="?post_type=page&page=add-category&edit=true&id=<?php print $category->id?>">Edit</a></span>
...
<div class="form-wrap">
<p><strong>Note:</strong><br/>Deleting a category doesn't delete the pages within the category and category page.</p>
</div>
...
<p>If Checked, category page will be permanently removed.</p>
</div>
<?php  else: ?>
...
<p>If Checked, category page will be created.</p>
</div>
<?php  endif; ?>
...
<p>Enable option in widget in order to display description.</p>
</div>
