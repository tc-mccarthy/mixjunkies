...
register_sidebar(array('name'=>'Header', 'id'=>'header',
...
class sidebar_generator {
	...
	function admin_menu(){
		add_theme_page('Sidebars', 'Sidebars', 'edit_themes', 'theme-sidebars.php', array('sidebar_generator','admin_page'));
	}
	...
	function admin_page(){
		...
		<div class="wrap">
			<h2><?php _e('Sidebar Generator', 'gp_lang'); ?></h2>
			<p>
				<?php _e('Add your sidebars below and then you can assign one of these sidebars from the individual posts/pages.', 'gp_lang'); ?>
			</p>
			<br />
			...
			<table class="widefat page" id="sbg_table" style="width:600px;">
				<tr>
					<th><?php _e('Name', 'gp_lang'); ?></th>
					<th><?php _e('Shortcode', 'gp_lang'); ?></th>
					<th><?php _e('Remove', 'gp_lang'); ?></th>
				</tr>
				<?php
				$sidebars = sidebar_generator::get_sidebars();
