...
define( 'NOTIFIER_THEME_NAME', 'Tarnished' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'tarnished' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.ghostpool.com/help/tarnished/lib/updater.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
